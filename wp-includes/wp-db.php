...
<h1>No podemos seleccionar una base de datos</h1>
<p>Podemos conectar con el servidor de bases de datos (lo que quiere decir que tu nombre de usuario y contraseña son correctos) pero no podemos seleccionar la base de datos <code>%1$s</code></p>
<ul>
<li>¿Estás seguro de que existe?</li>
<li>¿El usuario <code>%2$s</code> tiene permiso para usar la base de datos <code>%1$s</code>?</li>
<li>En algunos sistemas, la base de datos, viene con el prefijo de tu nombre de usuario, es decir, sería algo así como <code>usuario_%1$s</code>. ¿Podría ser este el problema?</li>
</ul>
<p>Si no sabes crear/configurar tu base de datos, deberías ponerte en contacto con el <strong>soporte de tu empresa de hosting</strong>. Si pese a todo falla, podrías buscar ayuda en los <a href="http://wordpress.org/support/">Foros de soporte oficiales de WordPress</a> (en Inglés), en <a href="http://www.buddypress-es.com/foros/">BuddyPress-es.com</a> (español) o <a href="http://ayudawordpress.com/foro/">AyudaWordpress.com</a> (español).</p>'/*/WP_I18N_DB_SELECT_DB*/, $db, $this->dbuser ), 'db_select_fail' );
			return;
		}
	}
