...
#adminmenu li div.wp-submenu ul {border:none;-moz-border-radius:0;-webkit-border-radius:0;border-radius:0;padding:0;}
.hiddenMenu #adminmenu li div.wp-submenu ul {border:none;-moz-border-radius:6px;-webkit-border-radius:6px;border-radius:6px;padding:6px 0;}
